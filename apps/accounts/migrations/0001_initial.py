    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to=apps.accounts.models.upload_to, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png']), apps.accounts.validators.validate_photo_weight])),
                ('username', models.CharField(error_messages={'unique': 'Ya existe un usuario con este nombre de usuario.'}, help_text='Su usuario debe tener y maximo 15 caracteres. Letras, dígitos y @/./+/-/_ solamente.', max_length=15, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='usuario')),
                ...
                ('is_active', models.BooleanField(default=False, help_text='Indica que la cuenta del usuario está activa.', verbose_name='activo')),
